...
//                if (!transformer.intToBinary(Integer.toString(Float.floatToIntBits(input[j] - input[i]))).equals(result.toString())){
//                    System.out.println("src: " + src);
//                    System.out.println("dest: " + dest);
//                    System.out.println("result: " + result);
//                    System.out.println("answer: " + transformer.intToBinary(Integer.toString(Float.floatToIntBits(input[j] - input[i]))));
//                    System.out.println("");
//                }
            }
        }
