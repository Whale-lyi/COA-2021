...
//                if (!transformer.intToBinary(Integer.toString(Float.floatToIntBits(input[i] + input[j]))).equals(result.toString())){
//                    System.out.println("src: " + src);
//                    System.out.println("dest: " + dest);
//                    System.out.println("result: " + result);
//                    System.out.println("answer: " + transformer.intToBinary(Integer.toString(Float.floatToIntBits(input[i] + input[j]))));
//                    System.out.println("");
//                }
            }
        }
